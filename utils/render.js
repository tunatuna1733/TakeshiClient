// Credit: nwjn
export const drawString = (text, x, y, z, color, scale = 1) => {
    ...
    GlStateManager.func_179114_b(-renderManager.field_78735_i, 0, 1, 0);
    GlStateManager.func_179114_b(renderManager.field_78732_j * xMultiplier, 1, 0, 0);
    GlStateManager.func_179152_a(-lScale, -lScale, lScale);
    GlStateManager.func_179140_f();
    GlStateManager.func_179132_a(false);

    // GlStateManager.func_179097_i() // comment this shit out and it works

    GlStateManager.func_179147_l();
    GlStateManager.func_179112_b(770, 771);

    const textWidth = fontRenderer.func_78256_a(text);
