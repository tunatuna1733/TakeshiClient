...
@Vigilant("TakeshiClient", "§d§lTakeshiClient", {
...
class Settings {
    ...
    editGui() {
        ChatLib.command('tc movehud', true);
    }
    ...
    @SwitchProperty({
        name: 'Draw mob box',
        description: 'Draws a box to the specified mobs. (aka Bestiary Helper)',
        category: 'Bestiary',
        subcategory: 'Mob Box'
    })
    mobbox = false;
    ...
    bestiaryGui() {
        java.awt.Desktop.getDesktop().browse(new java.net.URI('http://localhost:8086/bestiary'));
    }
    ...
    @SwitchProperty({
        name: 'Ping Graph',
        description: 'Draws a ping graph.(like valorant)',
        category: 'Others',
        subcategory: 'Ping'
    })
    pinggraph = false;
    ...
    constructor() {
        ...
        this.addDependency('Ping Graph', 'Ping Display');
